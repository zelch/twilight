...
// show 1/3 the pitch angle and all the roll angle
	...
	angles[ROLL] = 0; //V_CalcRoll (sv_player->v.angles, sv_player->v.velocity)*4;
...
//				Sys_Printf ("clc_nop\n");
			...
			case clc_stringcmd:	
				...
				if (Q_strncasecmp(s, "status", 6) == 0
				 ...
				 || Q_strncasecmp(s, "god", 3) == 0
				 || Q_strncasecmp(s, "notarget", 8) == 0
				 || Q_strncasecmp(s, "fly", 3) == 0
				 || Q_strncasecmp(s, "give", 4) == 0
				 || Q_strncasecmp(s, "noclip", 6) == 0)
				{
					ret = 1;
